...
if (isset($_POST['url']) && ($_POST['url'] != null)) {
	...
	if (isset($_POST['sh_url']) && ($_POST['sh_url'] != null)) 
	{
		...
		if (preg_match('#[^a-zA-Z0-9]+#', $_POST['sh_url']))//ищем не латиницу и не цифры
		{
			//если найдем не латинские символы или не цифры - выведем сообщение об ошибке и завершаем скрипт
